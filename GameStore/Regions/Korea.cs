...
namespace GameStore.Regions
{
    internal class Korea : IGame
    {
        ...
        public Korea(string timestamp, string title, string developer, string publisher, string genre, string platform, string region, decimal price)
        {
            TimeStamp = timestamp;
            Title = title;
            Developer = developer;
